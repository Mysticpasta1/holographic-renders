...
public class SpinPacket {
    ...
    public static final ResourceLocation UPDATE_ID = ResourceLocation.fromNamespaceAndPath(HolographicRenders.MOD_ID, "update_spin");
    public static final ResourceLocation ACTION_REQUEST_ID = ResourceLocation.fromNamespaceAndPath(HolographicRenders.MOD_ID, "update_spin_action");
    ...
    public static void onClientUpdate(Minecraft minecraftClient, ClientPacketListener clientPlayNetworkHandler, FriendlyByteBuf packetByteBuf, PacketSender packetSender) {
        ...
        minecraftClient.execute(() -> {
            if (minecraftClient.screen instanceof ProjectorScreen) {
                ((ProjectorScreen) minecraftClient.screen).setSpin(spin);
            }
        });
    }
